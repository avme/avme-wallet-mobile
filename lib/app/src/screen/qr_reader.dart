                          ...
                          Container(
                            ...
                            child: SizedBox(
                              ...
                              child: IconButton(
                                ...
                                icon: Icon(flashStatus ? Icons.flash_on : Icons.flash_off, size: 35,)
                                ),
                                  ...
                                  //       return Container();
                                  //     }
                                  //     return Icon(flashStatus ? Icons.flash_on : Icons.flash_off, size: 35,);
                                  //   },
                                  // )
                                ...
                                return SizedBox(
                                  ...
                                  child: IconButton(
                                    ...
                                    icon: FutureBuilder<CameraFacing>(
                                      future: controller?.getCameraInfo(),
                                      builder: (context, snapshot) {
                                        CameraFacing? facing = snapshot.data;
                                        if (facing != null) {
                                          return Icon(describeEnum(facing) == "back" ?
