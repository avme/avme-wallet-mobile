...
class AppTheme {
  ...
  static ThemeData settings = ThemeData.dark().copyWith(
    // Define the default brightness and colors.
...
class AppTextStyles {
  ...
  static final spanWhite = TextStyle(
      color: Colors.white,
      fontSize: DeviceSize.fontSize*1.3
  );
  static final spanWhiteMedium = TextStyle(
      color: Colors.white,
      fontSize: DeviceSize.fontSize*1.5
  );
  static final label = TextStyle(
      color: Colors.white,
      fontSize: DeviceSize.fontSizeLarge*1.3,
