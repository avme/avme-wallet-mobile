...
class _TokenDistributionState extends State<TokenDistribution> {
  ...
  Widget build(BuildContext context) {
    double piePad = 32;
    piePad = DeviceSize.deviceGroup == "SMALL" ? 8 : piePad;
    ...
    return AppCard(
      child: Column(
        children: [
          Text("This Account",style: TextStyle(fontSize: DeviceSize.labelSize*0.8)),
          SizedBox(
            height: DeviceSize.safeBlockVertical*1.5,
          ),
          Container(
            ...
            child: totalValue(widget.chartData) == 0
              ...
              child: Center(child: Text("No Data to be shown.",style: AppTextStyles.label.copyWith(fontSize: DeviceSize.fontSizeLarge)),),
            )
                : Row(
              children: [
                Expanded(
                    flex: DeviceSize.deviceGroup == "SMALL" ? 8 : 6,
                    child: Container(
                      child: Padding(
                        padding: EdgeInsets.only(
                          left: piePad, top: piePad, bottom: piePad, right: DeviceSize.safeBlockHorizontal*15,
          ...
          AppNeonButton(onPressed: () => widget.appScaffoldTabController.index = 0, text: "SHOW AVAILABLE TOKENS"),
        ],
      ),
    );
  }
    ...
    return Padding(
      ...
      child: Row(
        ...
        [
          ...
          Flexible(child: Text(this.text,style: TextStyle(fontSize: DeviceSize.fontSize*1.3))),
        ],
      ),
    );
  }
    ...
    return Padding(
      ...
      child: Text(this.text,
        style: TextStyle(
          ...
          fontSize: DeviceSize.fontSize * (1.4 - (scaling * 0.03)),
        ),
      ),
    );
  }
