          ...
          children: [
            TextFormField(
              ...
              decoration: InputDecoration(
                ...
                labelStyle: TextStyle(color: cLabelStyle, fontWeight: fLabelStyle, fontSize: DeviceSize.fontSize),
                ...
                counter:
                  ...
                  ? null
                  : Align(
                    alignment: Alignment.centerRight.add(Alignment(DeviceSize.blockSizeHorizontal / 100 * 1.5, 0)),
                    child:
                      Container(
                        // color:Colors.red,
                        child: Text(
                          ...
                          style: AppTextStyles.span.copyWith(fontSize: DeviceSize.fontSize),
                        )
                      ),
                    )
                )
