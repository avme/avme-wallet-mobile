...
class AppNeonButton extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    TextStyle btnStyle = this.textStyle == null
        ? TextStyle(color: this.enabled ? AppColors.purple : AppColors.labelDisabledColor, fontSize: this.size ?? SizeConfig.spanSize * 1.6)
      ...
      child: ElevatedButton(
          ...
          style: ButtonStyle(
              ...
              shape: MaterialStateProperty.all<RoundedRectangleBorder>(RoundedRectangleBorder(
                  borderRadius: BorderRadius.circular(6.0), side: BorderSide(width: 2, color: this.enabled ? AppColors.purple : AppColors.violet))))),
    );
  }
}
